        ...
        <div class="card mt-5">
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    @csrf
                    <legend class="text-center fw-bolder text-primary">Create Table</legend>
                    @if(session('status'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="tag" type="text" placeholder="Enter Tags" class="form-control shadow-sm @error('tag') is-invalid @enderror" name="tag" value="{{ old('tag') }}" autocomplete="tag" autofocus>
